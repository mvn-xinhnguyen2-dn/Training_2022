...
//5.1: map: tạo biến mới có số cùng số lượng phân tử, và nhận giá trị array với những thay đổi mới.
...
//5.2: filter: tìm kiếm và trả về tất cả các phần tử thõa mãn đk. "ai ở huế?"

var hueProvince = info.filter(function (info, index){
  return info.province == "huế"
})
console.log("5.2 ví dụ: filter, ai ở huế?: " + hueProvince)

//5.3: reduce: tính toán trong mảng, tính độ tuổi trung bình.
...
//5.4: find: tìm kiếm phần tử vs đk tương ứng. Đúng--> kq trả đúng phân tử đó, và thoát.

var isHue = info.find( function (info, index){
  return info.province == "huế"
})
console.log("5.4 ví dụ: find, có aj ở huế k?: " + isHue)

//5.5: some: chỉ cần 1 phần tử thõa mãn--> true

var over20 = info.some( function (info, index){
  return info.age > 20
})
console.log("5.5 ví dụ: some, có người trên 20 tuổi?: " + over20)
...
console.log("bài 1.1: a + b = " + output11);

var output12 = sum(5, 5);
console.log("bài 1.2: a + b = " + output12);
...
console.log("bài 2.1: |a-19| = " + output21);

var output22 = abs19(19)
console.log("bài 2.2: |a-19| = " + output22);

var output23 = abs19(22)
console.log("bài 2.3: |a-19|*3 = " + output23);
...
// UPDATE thuật toán. sử dụng switch case, thay thế * để số chia hết cho 3.
var sumA = 0
var arrayDivisible3 = []
